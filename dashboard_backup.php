  ...
  <style>
    ...
    .empty-state i {
      ...
      opacity: 0.5;
            ...
            /* Enhanced Loading Spinner */    .spinner {      display: none;      position: fixed;      top: 0;       left: 0;       width: 100vw;      height: 100vh;      background: rgba(5, 150, 105, 0.1);      backdrop-filter: blur(8px);      z-index: 99999;      animation: fadeIn 0.3s ease-out;    }        .spinner.show {      display: flex !important;      justify-content: center;      align-items: center;    }
